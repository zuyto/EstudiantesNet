...
namespace EstudiantesNet.UnitTests.Infrastructure
{
	public class DependecyInjectionTests
	{
		...
		public void AddInfrastructure_ShouldConfigureServicesCorrectly()
		{
			...
			Assert.Contains(services, s => s.ServiceType == typeof(IUnitOfWorkEstudiantesDb));
		}
		...
		public void ConfigureAppSettingsManagerConnections_ShouldConfigureAppSettingsCorrectly()
		{
			...
			Environment.SetEnvironmentVariable(ConfigurationStruct.ESTUDIANTES_DB, "TestConnectionString");
