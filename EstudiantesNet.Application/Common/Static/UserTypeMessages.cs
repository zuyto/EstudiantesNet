...
namespace EstudiantesNet.Application.Common.Static
{
	/// <summary>
	...
	public static class UserTypeMessages
	{
		...
		public const string ERRUSRTP02 = "EL ID ESTUDIEANTE NO TIENE DATOS REGISTRADOS";
		public const string MENSAJE_MATERIAS = "NO PUEDES TENER MATERIAS CON EL MISMO PROFESOR.";
