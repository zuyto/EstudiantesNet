...
//using EstudiantesNet.Application.Common.Enumerations;
//using EstudiantesNet.Application.Common.Helpers;
//using EstudiantesNet.Application.Common.Interfaces.ArmarJson;
...
//        public async Task<DtoGenericResponse> ProcesaTrxOm11Om12(DtoJsonRequest request)
//        {
//            string?[] stickers = [];
