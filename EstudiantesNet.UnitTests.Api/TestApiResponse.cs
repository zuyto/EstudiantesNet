...
namespace EstudiantesNet.UnitTests.Api
{
	public class TestApiResponse
	{
		...
		{
			var result = GenericHelpers.BuildResponse<DtoJsonResponseRegistrar>(false, null, "Mensaje error");
